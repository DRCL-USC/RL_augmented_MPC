...
class BezierGait():
    ...
    def GetFootStep(self, L, LateralFraction, YawRate, clearance_height,
        ...
        print('key',key,'index', index, 'phase', phase, 'StanceSwing', StanceSwing)
    ...
    def GenerateTrajectory(self,
        ...
        print('TSTANCE', Tstance, 'TD', self.TD)
        T_bf = copy.deepcopy(T_bf_)
        for i, (key, Tbf_in) in enumerate(T_bf_.items()):
            # TODO: MAKE THIS MORE ELEGANT
            print('i, key, Tbf_in', i, key, Tbf_in)
            print('L', L)
            print('LateralFraction', LateralFraction)
            print('YawRate',YawRate)
            print('clearance_height',clearance_height)
            print('Tstance',Tstance)
            # print('p_bf', p_bf)
            ...
            if key == "BR":
                self.dSref[i] = 0.0
            # position of foot from homogeneous transform    
            ...
            print('Tbf in', Tbf_in, 'step coord', step_coord)
            T_bf[key] = Tbf_in + step_coord
        return T_bf
